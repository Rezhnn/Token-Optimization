...
function Write-Success { param($msg) Write-Host "[finops] OK " -ForegroundColor Green -NoNewline; Write-Host $msg }
function Write-Warn    { param($msg) Write-Host "[finops] WARN " -ForegroundColor Yellow -NoNewline; Write-Host $msg }
...
Write-Host ""
Write-Host "  Zone-Based Execution is now active in this workspace when your agent reads these files."
